 ...
 * The notes come together like you wouln't believe as the musician puts together patterns of tunes. As you
 * wonder what kind of algorithm you could use to shift octaves by 8 pitches or something silly like that,
 * it dawns on you that you have been watching the musician for some 10 odd minutes. You ask, "How much do people
 * normally tip for something like this?" The artist looks up. "Its always gonna be about tree fiddy."
 *
 * It was then that you realize the musician was a 400 foot tall beast from the paleolithic era. The Loch
 * Ness Monster almost tricked you!
 *
...
public class AStrangeTrip {

    public static boolean isLockNessMonster(String s){
        if (s.contains("3.50") || s.contains("three fifty") || s.contains("tree fiddy") || s.contains("400 foot")) {
            return true;
        } else {
            return false;
        }
